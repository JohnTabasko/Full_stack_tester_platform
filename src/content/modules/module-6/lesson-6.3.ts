...
export const lesson6_3: Lesson = {
  ...
  "description": "Komponenty interfejsu użytkownika wielokrotnego użycia: modal, tabela, nagłówek, paginacja i kompozycja ponad dziedziczenie.",
  "order": 3,
  ...
  "content": {
    "objective": "Po ukończeniu lekcji potrafisz zastosować temat „Wzorzec komponentu” w architekturze testów Playwright, rozumiesz jego zalety, ograniczenia i typowe antywzorce.",
    "theory": theory6_3,
    "codeExamples": [
      "export class ModalComponent {\n  constructor(private readonly root: Locator) {}\n\n  async confirm() { await this.root.getByRole('button', { name: 'Potwierdź' }).click(); }\n  async cancel() { await this.root.getByRole('button', { name: 'Anuluj' }).click(); }\n  async expectVisible() { await expect(this.root).toBeVisible(); }\n}\n",
      "export class OrdersPage {\n  readonly deleteModal: ModalComponent;\n  constructor(private readonly page: Page) {\n    this.deleteModal = new ModalComponent(page.getByRole('dialog', { name: 'Usuń zamówienie' }));\n  }\n}\n"
    ],
    "exercises": [
      {
        "id": "ex-6-3-1",
        "title": "Projekt klasy",
        "description": "Zaprojektuj Page Object lub komponent dla tematu „Wzorzec komponentu”, wskazując odpowiedzialności publiczne i prywatne."
      },
      {
        "id": "ex-6-3-2",
    ...
    "quiz": [
      ...
      {
        "id": "q6-3-8",
        "question": "Najważniejsza zasada lekcji „Wzorzec komponentu” to:",
        "options": [
