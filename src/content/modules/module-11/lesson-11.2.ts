...
import theory11_2 from './lesson-11.2.md?raw';

export const lesson11_2: Lesson = {
  "id": "11.2",
  "moduleId": 11,
  "title": "Integracja z GitLab CI/CD",
  "description": ".gitlab-ci.yml, etapy, cache, równoległość, artefakty, GitLab Pages i pipeline merge requestów.",
  "order": 2,
  "difficulty": "advanced",
  "tags": [
    "ci-cd",
  ...
  "content": {
    ...
    "exercises": [
      {
        ...
        "description": "Dla tematu „Integracja z GitLab CI/CD” zaprojektuj pipeline: install, typecheck/lint, test, artefakty."
      },
      {
        "id": "ex-11-2-2",
        "title": "Smoke vs full",
    ...
    "quiz": [
      ...
      {
        "id": "q11-2-8",
        "question": "Najważniejsza zasada lekcji „Integracja z GitLab CI/CD” to:",
        "options": [
