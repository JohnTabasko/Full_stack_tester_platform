...
import theory11_4 from './lesson-11.4.md?raw';

export const lesson11_4: Lesson = {
  "id": "11.4",
  "moduleId": 11,
  "title": "Azure DevOps i inne platformy CI/CD",
  "description": "Azure Pipelines, CircleCI, Bitbucket, testowanie w chmurze, BrowserStack/Sauce Labs, matrix i wieloprzeglądarkowe testy w chmurze.",
  "order": 4,
  "difficulty": "advanced",
  "tags": [
    "ci-cd",
  ...
  "content": {
    "objective": "Po ukończeniu lekcji potrafisz zaprojektować pipeline dla tematu „Azure DevOps i inne platformy CI/CD”, który daje szybki feedback, publikuje artefakty diagnostyczne i bezpiecznie obsługuje konfigurację oraz sekrety.",
    "theory": theory11_4,
    "codeExamples": [
      "trigger:\n  - main\n\njobs:\n  - job: e2e\n    pool: { vmImage: 'ubuntu-latest' }\n    strategy:\n      matrix:\n        chromium: { PROJECT: 'chromium' }\n        webkit: { PROJECT: 'webkit' }\n    steps:\n      - task: NodeTool@0\n        inputs: { versionSpec: '20.x' }\n      - script: npm ci\n      - script: npx playwright install --with-deps\n      - script: npx playwright test --project=$(PROJECT)\n      - publish: playwright-report\n        artifact: playwright-report\n",
      "# Strategia użycia cloud device farm\nPR: lokalne browsery + smoke\nNightly: cross-browser cloud\nRelease: real devices + krytyczne przepływy\n"
    ],
    "exercises": [
      {
        "id": "ex-11-4-1",
        "title": "Pipeline podstawowy",
        "description": "Dla tematu „Azure DevOps i inne platformy CI/CD” zaprojektuj pipeline: install, typecheck/lint, test, artefakty."
      },
      {
        "id": "ex-11-4-2",
        "title": "Smoke vs full",
    ...
    "quiz": [
      ...
      {
        "id": "q11-4-8",
        "question": "Najważniejsza zasada lekcji „Azure DevOps i inne platformy CI/CD” to:",
        "options": [
