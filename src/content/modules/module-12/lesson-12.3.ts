...
import theory12_3 from './lesson-12.3.md?raw';

export const lesson12_3: Lesson = {
  "id": "12.3",
  "moduleId": 12,
  "title": "Jakość kodu i utrzymywalność",
  "description": "SOLID, ESLint, Prettier, tryb strict, refaktoryzacja, metryki kodu i techniki upraszczania testów.",
  "order": 3,
  "difficulty": "advanced",
  "tags": [
    "best-practices",
  ...
  "content": {
    "objective": "Po ukończeniu lekcji potrafisz zastosować temat „Jakość kodu i utrzymywalność” w sposób świadomy: rozpoznajesz korzyści, ograniczenia, antywzorce i wpływ na utrzymywalność testów.",
    "theory": theory12_3,
    "codeExamples": [
      "// Przed refaktorem: test robi setup, akcje, API i cleanup w jednym bloku.\n// Po refaktorze: jawne kroki i helpery o jednej odpowiedzialności.\nawait test.step('Create test user', async () => { user = await usersApi.create(customer()); });\nawait test.step('Perform checkout', async () => { await checkout.buy(product); });\nawait test.step('Assert order', async () => { await expectOrderPaid(orderId); });\n",
    ...
    "exercises": [
      {
        ...
        "description": "Dla obszaru „Jakość kodu i utrzymywalność” przeanalizuj istniejący test i wskaż trzy usprawnienia."
      },
      {
        "id": "ex-12-3-2",
    ...
    "quiz": [
      ...
      {
        "id": "q12-3-8",
        "question": "Najważniejsza zasada lekcji „Jakość kodu i utrzymywalność” to:",
        "options": [
