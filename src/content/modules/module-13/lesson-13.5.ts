...
import theory13_5 from './lesson-13.5.md?raw';

export const lesson13_5: Lesson = {
  "id": "13.5",
  "moduleId": 13,
  "title": "Monitorowanie wydajności i ciągła kontrola wydajności",
  "description": "Prometheus, Grafana, wykrywanie regresji, budżety CI, alertowanie, długoterminowe śledzenie i porównanie z baseline.",
  "order": 5,
  "difficulty": "advanced",
  "tags": [
    "performance",
  ...
  "content": {
    "objective": "Po ukończeniu lekcji potrafisz mierzyć i optymalizować obszar „Monitorowanie wydajności i ciągła kontrola wydajności” z użyciem baseline, metryk, budżetów wydajnościowych i świadomej analizy kompromisów.",
    "theory": theory13_5,
    "codeExamples": [
      "type PerformanceSample = {\n  timestamp: string;\n  metric: 'checkout_p95' | 'lcp_p75' | 'bundle_size_kb';\n  value: number;\n  commit: string;\n};\n",
      "# Przykład alertu\nPerformance budget exceeded:\nmetric: checkout_p95\nvalue: 980ms\nbudget: 800ms\nenvironment: staging\ncommit: abc123\nreport: https://ci.example/report/123\n"
    ],
    "exercises": [
      {
        "id": "ex-13-5-1",
        "title": "Baseline",
        "description": "Dla tematu „Monitorowanie wydajności i ciągła kontrola wydajności” zaprojektuj pomiar bazowy i wskaż, jakie dane zapiszesz w raporcie."
      },
      {
        "id": "ex-13-5-2",
    ...
    "quiz": [
      ...
      {
        "id": "q13-5-8",
        "question": "Najważniejsza zasada lekcji „Monitorowanie wydajności i ciągła kontrola wydajności” to:",
        "options": [
