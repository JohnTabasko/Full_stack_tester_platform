...
export const lesson21_2: Lesson = {
  ...
  "content": {
    "objective": "Po ukończeniu lekcji rozumiesz ideę testy kontraktowe sterowane przez konsumenta, potrafisz zaprojektować kontrakt z perspektywy konsumenta i wiesz, jak provider weryfikuje zgodność bez uruchamiania pełnego E2E.",
    "theory": theory21_2,
    "codeExamples": [
      "// Przykład koncepcyjny testu konsumenta Pact.\nawait provider.addInteraction({\n  state: 'order ord-123 exists',\n  uponReceiving: 'a request for order details',\n  withRequest: { method: 'GET', path: '/orders/ord-123' },\n  willRespondWith: {\n    status: 200,\n    headers: { 'Content-Type': 'application/json' },\n    body: {\n      id: 'ord-123',\n      status: 'paid',\n      estimatedDeliveryDate: '2026-06-21',\n    },\n  },\n});\n",
      "# Typowy pipeline\n# 1. Consumer test -> publikuje pact\n# 2. Provider verification -> pobiera pact z brokera\n# 3. can-i-deploy -> sprawdza zgodność wersji\n"
    ],
    "exercises": [
      {
        "id": "ex-21-2-1",
        "title": "Mapa konsumentów",
        "description": "Dla API z tematu „Testy kontraktowe sterowane przez konsumenta z Pact” wypisz konsumentów i pola, których naprawdę potrzebują."
      },
      {
        "id": "ex-21-2-2",
    ...
    "quiz": [
      ...
      {
        "id": "q21-2-8",
        "question": "Jaki jest najważniejszy rezultat lekcji „Testy kontraktowe sterowane przez konsumenta z Pact”?",
        "options": [
