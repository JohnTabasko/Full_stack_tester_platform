...
export const lesson2_8: Lesson = {
  ...
  "description": "Interakcje myszy, klawiatury, focus management, tooltipy, drag & drop i touch events",
  "order": 8,
  "difficulty": "beginner",
  "tags": [
    "playwright",
  ...
  "content": {
    "objective": "Po ukończeniu lekcji rozumiesz temat: Najechanie, fokus oraz przeciąganie i upuszczanie, potrafisz zastosować go w stabilnych testach Playwright oraz wiesz, jak unikać typowych pułapek synchronizacji i selektorów.",
    "theory": theory2_8,
    "codeExamples": [
      "await page.getByRole('button', { name: 'Pomoc' }).hover();\nawait expect(page.getByRole('tooltip')).toBeVisible();\n\nawait page.keyboard.press('Tab');\nawait expect(page.getByRole('button', { name: 'Pomoc' })).toBeFocused();\n",
      "await page.getByText('Zadanie A').dragTo(page.getByText('Kolumna Gotowe'));\nawait expect(page.getByTestId('done-column')).toContainText('Zadanie A');\n"
    ],
    "exercises": [
      {
        "id": "ex-2-8-1",
        "title": "Minimalny scenariusz",
        "description": "Przygotuj krótki test dla tematu „Najechanie, fokus oraz przeciąganie i upuszczanie”, zawierający akcję i asercję rezultatu."
      },
      {
        "id": "ex-2-8-2",
    ...
    "quiz": [
      {
        "id": "q2-8-1",
        "question": "Jaki jest główny cel zagadnienia „Najechanie, fokus oraz przeciąganie i upuszczanie”?",
        "options": [
