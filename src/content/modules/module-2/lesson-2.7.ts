...
export const lesson2_7: Lesson = {
  ...
  "content": {
    "objective": "Po ukończeniu lekcji rozumiesz temat: Akcje zaawansowane, potrafisz zastosować go w stabilnych testach Playwright oraz wiesz, jak unikać typowych pułapek synchronizacji i selektorów.",
    "theory": theory2_7,
    "codeExamples": [
      ...
      "const downloadPromise = page.waitForEvent('download');\nawait page.getByRole('button', { name: 'Pobierz raport' }).click();\nconst download = await downloadPromise;\nexpect(download.suggestedFilename()).toContain('raport');\n"
    ],
    "exercises": [
      {
        "id": "ex-2-7-1",
        "title": "Minimalny scenariusz",
        "description": "Przygotuj krótki test dla tematu „Akcje zaawansowane”, zawierający akcję i asercję rezultatu."
      },
      {
        "id": "ex-2-7-2",
    ...
    "quiz": [
      {
        "id": "q2-7-1",
        "question": "Jaki jest główny cel zagadnienia „Akcje zaawansowane”?",
        "options": [
