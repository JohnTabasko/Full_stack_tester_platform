...
import theory10_1 from './lesson-10.1.md?raw';

export const lesson10_1: Lesson = {
  "id": "10.1",
  "moduleId": 10,
  "title": "Raportowanie wbudowane",
  "description": "Reportery HTML, JSON, JUnit, GitHub, list, dot, line, blob oraz załączniki.",
  "order": 1,
  ...
  "content": {
    "objective": "Po ukończeniu lekcji potrafisz zaprojektować raportowanie dla tematu „Raportowanie wbudowane” tak, aby wspierało diagnozę, decyzje zespołu i jakość procesu CI/CD.",
    "theory": theory10_1,
    "codeExamples": [
      "export default defineConfig({\n  reporter: [\n    ['html', { open: 'never', wyjścieFolder: 'playwright-report' }],\n    ['junit', { wyjścieFile: 'test-results/junit.xml' }],\n    ['json', { wyjścieFile: 'test-results/results.json' }],\n    ['github'],\n  ],\n});\n",
    ...
    "exercises": [
      {
        ...
        "description": "Dla tematu „Raportowanie wbudowane” zaprojektuj raport dla developera, QA leada i managera."
      },
      {
        "id": "ex-10-1-2",
    ...
    "quiz": [
      ...
      {
        "id": "q10-1-8",
        "question": "Najważniejsza zasada lekcji „Raportowanie wbudowane” to:",
        "options": [
