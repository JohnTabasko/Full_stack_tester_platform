...
import theory10_4 from './lesson-10.4.md?raw';

export const lesson10_4: Lesson = {
  "id": "10.4",
  "moduleId": 10,
  "title": "Integracja z Allure",
  "description": "Konfiguracja Allure, adnotacje, severity, epic, feature, kroki, kategorie, historia i hosting raportów.",
  "order": 4,
  ...
  "content": {
    "objective": "Po ukończeniu lekcji potrafisz zaprojektować raportowanie dla tematu „Integracja z Allure” tak, aby wspierało diagnozę, decyzje zespołu i jakość procesu CI/CD.",
    "theory": theory10_4,
    "codeExamples": [
      "import { test } from '@playwright/test';\nimport * as allure from 'allure-js-commons';\n\ntest('checkout guest purchase', async ({ page }) => {\n  await allure.epic('E-commerce');\n  await allure.feature('Checkout');\n  await allure.severity('critical');\n  await allure.owner('team-checkout');\n});\n",
      "// kategorie.json — koncepcyjnie\n[\n  { \"name\": \"Locator issue\", \"matchedStatuses\": [\"failed\"], \"messageRegex\": \".*strict mode.*\" },\n  { \"name\": \"Timeout\", \"matchedStatuses\": [\"failed\"], \"messageRegex\": \".*Timeout.*\" }\n]\n"
    ],
    "exercises": [
      {
        "id": "ex-10-4-1",
        "title": "Raport dla odbiorcy",
        "description": "Dla tematu „Integracja z Allure” zaprojektuj raport dla developera, QA leada i managera."
      },
      {
        "id": "ex-10-4-2",
    ...
    "quiz": [
      ...
      {
        "id": "q10-4-8",
        "question": "Najważniejsza zasada lekcji „Integracja z Allure” to:",
        "options": [
