...
import theory10_3 from './lesson-10.3.md?raw';

export const lesson10_3: Lesson = {
  "id": "10.3",
  "moduleId": 10,
  "title": "Analityka testów i metryki",
  "description": "Zbieranie metryk, pass rate, flaky rate, czas p95, Grafana, analiza trendów i kondycja pakietu.",
  "order": 3,
  ...
  "content": {
    "objective": "Po ukończeniu lekcji potrafisz zaprojektować raportowanie dla tematu „Analityka testów i metryki” tak, aby wspierało diagnozę, decyzje zespołu i jakość procesu CI/CD.",
    "theory": theory10_3,
    "codeExamples": [
      "type TestRunMetrics = {\n  runId: string;\n  passed: number;\n  failed: number;\n  flaky: number;\n  durationMs: number;\n};\n\nfunction passRate(m: TestRunMetrics) {\n  return m.passed / (m.passed + m.failed + m.flaky);\n}\n",
      "// p95 czasu testów — pseudokod\nconst sorted = durationsMs.toSorted((a, b) => a - b);\nconst p95 = sorted[Math.floor(sorted.length * 0.95)];\n"
    ],
    "exercises": [
      {
        "id": "ex-10-3-1",
        "title": "Raport dla odbiorcy",
        "description": "Dla tematu „Analityka testów i metryki” zaprojektuj raport dla developera, QA leada i managera."
      },
      {
        "id": "ex-10-3-2",
    ...
    "quiz": [
      ...
      {
        "id": "q10-3-8",
        "question": "Najważniejsza zasada lekcji „Analityka testów i metryki” to:",
        "options": [
