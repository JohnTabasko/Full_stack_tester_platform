...
export const lesson14_4: Lesson = {
  ...
  "description": "OWASP ZAP, testowanie SQL injection, wykrywanie XSS, nagłówki bezpieczeństwa, obejście uwierzytelniania, rate limiting i przechowywanie JWT.",
  "order": 4,
  "difficulty": "advanced",
  "tags": [
    "security",
  ...
  "content": {
    ...
    "theory": theory14_4,
    "codeExamples": [
      "# OWASP ZAP baseline scan — koncepcyjnie\n docker run -t owasp/zap2docker-stable zap-baseline.py    -t https://staging.example.test    -r zap-report.html\n",
      "const response = await request.get(`/api/orders/${otherTenantOrderId}`, {\n  headers: { Authorization: `Bearer ${userToken}` },\n});\nexpect([403, 404]).toContain(response.status());\n"
    ],
    "exercises": [
      {
        "id": "ex-14-4-1",
        "title": "Mapa ryzyk",
        "description": "Dla tematu „Podstawy testów penetracyjnych” wypisz ryzyka, dane testowe i oczekiwane dowody."
      },
      {
        "id": "ex-14-4-2",
    ...
    "quiz": [
      ...
      {
        "id": "q14-4-8",
        "question": "Najważniejsza zasada lekcji „Podstawy testów penetracyjnych” to:",
        "options": [
