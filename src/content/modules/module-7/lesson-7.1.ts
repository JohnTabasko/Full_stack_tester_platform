...
import theory7_1 from './lesson-7.1.md?raw';

export const lesson7_1: Lesson = {
  "id": "7.1",
  "moduleId": 7,
  "title": "Strategie danych testowych",
  "description": "Dane wpisane na stałe, fixture JSON, fabryka, budowniczy, Faker.js, setup przez API, seed bazy danych i wybór strategii według ryzyka.",
  "order": 1,
  ...
  "content": {
    "objective": "Po ukończeniu lekcji potrafisz zaprojektować i utrzymywać dane testowe dla tematu „Strategie danych testowych”, z uwzględnieniem izolacji, powtarzalności, prywatności i sprzątania danych.",
    "theory": theory7_1,
    "codeExamples": [
      "type DataStrategy = 'inline' | 'json-fixture' | 'factory' | 'builder' | 'api-setup' | 'db-seed';\n\ntype TestDataDecision = {\n  scenario: string;\n  strategy: DataStrategy;\n  reason: string;\n};\n\nconst decisions: TestDataDecision[] = [\n  { scenario: 'login smoke', strategy: 'json-fixture', reason: 'stałe konto techniczne' },\n  { scenario: 'checkout', strategy: 'api-setup', reason: 'realistyczny produkt i koszyk' },\n  { scenario: 'walidacja formularza', strategy: 'builder', reason: 'wiele wariantów danych' },\n];\n",
      "// runId jako wspólny identyfikator danych i diagnostyki\nconst runId = `e2e-${Date.now()}`;\nconst email = `qa+${runId}@example.test`;\n"
    ],
    "exercises": [
      {
        "id": "ex-7-1-1",
        "title": "Strategia danych",
        "description": "Dla tematu „Strategie danych testowych” wybierz strategię danych i uzasadnij ją przez ryzyko, koszt i powtarzalność."
      },
      {
        "id": "ex-7-1-2",
    ...
    "quiz": [
      ...
      {
        "id": "q7-1-8",
        "question": "Najważniejsza zasada lekcji „Strategie danych testowych” to:",
        "options": [
