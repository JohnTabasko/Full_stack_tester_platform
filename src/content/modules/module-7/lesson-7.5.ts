...
import theory7_5 from './lesson-7.5.md?raw';

export const lesson7_5: Lesson = {
  "id": "7.5",
  "moduleId": 7,
  ...
  "content": {
    "objective": "Po ukończeniu lekcji potrafisz zaprojektować i utrzymywać dane testowe dla tematu „Organizacja i utrzymanie danych testowych”, z uwzględnieniem izolacji, powtarzalności, prywatności i sprzątania danych.",
    "theory": theory7_5,
    "codeExamples": [
      "src/test-data/\n  builders/userBuilder.ts\n  builders/orderBuilder.ts\n  factories/users.ts\n  fixtures/countries.json\n  schemas/order.schema.json\n  seeds/minimalCatalog.ts\n",
    ...
    "exercises": [
      {
        ...
        "description": "Dla tematu „Organizacja i utrzymanie danych testowych” wybierz strategię danych i uzasadnij ją przez ryzyko, koszt i powtarzalność."
      },
      {
        "id": "ex-7-5-2",
    ...
    "quiz": [
      ...
      {
        "id": "q7-5-8",
        "question": "Najważniejsza zasada lekcji „Organizacja i utrzymanie danych testowych” to:",
        "options": [
