...
import theory1_2 from './lesson-1.2.md?raw';

export const lesson1_2: Lesson = {
  "id": "1.2",
  "moduleId": 1,
  "title": "Instalacja i konfiguracja środowiska",
  "description": "Instalacja Playwright, konfiguracja TypeScript, Node.js, przeglądarek, skryptów npm i diagnostyka pierwszego uruchomienia.",
  "order": 2,
  "difficulty": "beginner",
  "tags": [
    "installation",
  ...
  "content": {
    "objective": "Po ukończeniu lekcji potrafisz zainstalować Playwright w projekcie TypeScript, uruchomić pierwszy test, skonfigurować skrypty npm i zdiagnozować typowe problemy środowiskowe.",
    "theory": theory1_2,
    "codeExamples": [
    ...
    "exercises": [
      {
        ...
        "description": "Wyjaśnij własnymi słowami temat „Instalacja i konfiguracja środowiska” i wskaż, jakie ryzyko rozwiązuje w projekcie testowym."
      },
      {
        "id": "ex-1-2-2",
    ...
    "quiz": [
      {
        "id": "q1-2-1",
        "question": "Jaki jest najważniejszy cel lekcji „Instalacja i konfiguracja środowiska”?",
        "options": [
