...
import theory1_5 from './lesson-1.5.md?raw';

export const lesson1_5: Lesson = {
  "id": "1.5",
  "moduleId": 1,
  "title": "Pierwszy test — anatomia testu Playwright",
  "description": "Pierwszy test Playwright od importu po asercje, lokatory, kroki, diagnostykę, uruchomienie i interpretację wyniku.",
  "order": 5,
  "difficulty": "beginner",
  "tags": [
    "first-test",
  ...
  "content": {
    ...
    "exercises": [
      {
        ...
        "description": "Wyjaśnij własnymi słowami temat „Pierwszy test — anatomia testu Playwright” i wskaż, jakie ryzyko rozwiązuje w projekcie testowym."
      },
      {
        "id": "ex-1-5-2",
    ...
    "quiz": [
      {
        "id": "q1-5-1",
        "question": "Jaki jest najważniejszy cel lekcji „Pierwszy test — anatomia testu Playwright”?",
        "options": [
