...
import theory1_4 from './lesson-1.4.md?raw';

export const lesson1_4: Lesson = {
  "id": "1.4",
  "moduleId": 1,
  "title": "Konfiguracja playwright.config.ts — omówienie szczegółowe",
  "description": "Timeouty, projekty, use, baseURL, trace, screenshoty, video, retries, workers, reportery i konfiguracja CI.",
  "order": 4,
  "difficulty": "beginner",
  "tags": [
    "playwright-config",
  ...
  "content": {
    "objective": "Po ukończeniu lekcji rozumiesz najważniejsze opcje playwright.config.ts i potrafisz skonfigurować projekt pod lokalny development, CI, diagnostykę awarii i wieloprzeglądarkowość.",
    "theory": theory1_4,
    "codeExamples": [
      "import { defineConfig, devices } from '@playwright/test';\n\nexport default defineConfig({\n  testDir: './tests',\n  timeout: 30_000,\n  retries: process.env.CI ? 2 : 0,\n  workers: process.env.CI ? 4 : undefined,\n  reporter: [['html'], ['junit', { outputFile: 'test-results/junit.xml' }]],\n  use: {\n    baseURL: process.env.BASE_URL ?? 'http://localhost:3000',\n    trace: 'retain-on-failure',\n    screenshot: 'only-on-failure',\n    video: 'retain-on-failure',\n  },\n  projects: [\n    { name: 'chromium', use: { ...devices['Desktop Chrome'] } },\n    { name: 'webkit', use: { ...devices['Desktop Safari'] } },\n    { name: 'mobile-chrome', use: { ...devices['Pixel 7'] } },\n  ],\n});\n",
      "// Antywzorzec\n// timeout: 180_000 // bo czasem CI jest wolne\n\n// Lepsze pytanie: który krok jest wolny i jaki stan naprawdę powinien być oczekiwany?\n"
    ],
    "exercises": [
      {
        "id": "ex-1-4-1",
        "title": "Notatka koncepcyjna",
        "description": "Wyjaśnij własnymi słowami temat „Konfiguracja playwright.config.ts — omówienie szczegółowe” i wskaż, jakie ryzyko rozwiązuje w projekcie testowym."
      },
      {
        "id": "ex-1-4-2",
    ...
    "quiz": [
      {
        "id": "q1-4-1",
        "question": "Jaki jest najważniejszy cel lekcji „Konfiguracja playwright.config.ts — omówienie szczegółowe”?",
        "options": [
